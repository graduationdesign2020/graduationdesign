...
class StudentSpider(scrapy.Spider):
    ...
    def parse(self, response):
        yield scrapy.Request(
            url="http://bysj.jwc.sjtu.edu.cn/ZhuanYe/ZYxsList.aspx?type=1&zyno=537&sid=Jk7UDmg/cSOg6wXocnYmog....&screen=Qd2HRMrs8oJGtA82doE7Jg....",
    ...
    def parse_student(self, response):
        ...
        if current_page < total_page:
            url = "http://bysj.jwc.sjtu.edu.cn/ZhuanYe/ZYxsList.aspx?type=1&zyno=537&sid=Jk7UDmg%2fcSOg6wXocnYmog....&screen=Qd2HRMrs8oJGtA82doE7Jg...."
            post_data = {
