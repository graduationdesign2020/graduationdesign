...
class State3Spider(scrapy.Spider):
    name = 'state3'
    ...
    def parse(self, response):
        yield scrapy.Request(
            url="http://bysj.jwc.sjtu.edu.cn/Admin/TotleLunWenLook.aspx?type=wtj&sid=Jk7UDmg/cSOg6wXocnYmog....&screen=Qd2HRMrs8oJGtA82doE7Jg....&zhuanyeno=537",
            callback=self.parse_submit1)
        yield scrapy.Request(
            url="http://bysj.jwc.sjtu.edu.cn/Admin/TotleLunWenLook.aspx?type=shtg&sid=Jk7UDmg/cSOg6wXocnYmog....&screen=Qd2HRMrs8oJGtA82doE7Jg....&zhuanyeno=537",
    ...
    def parse_submit1(self, response):
        ...
        if current_page < total_page:
            url = "http://bysj.jwc.sjtu.edu.cn/Admin/TotleLunWenLook.aspx?type=wtj&sid=Jk7UDmg%2fcSOg6wXocnYmog....&screen=Qd2HRMrs8oJGtA82doE7Jg....&zhuanyeno=537"
            post_data = {
    ...
    def parse_submit5(self, response):
        ...
        total_page = response.css("span#LblPageCount::text").re(r'\d+')
        if current_page < total_page:
            url = "http://bysj.jwc.sjtu.edu.cn/Admin/TotleLunWenLook.aspx?type=shtg&sid=Jk7UDmg%2fcSOg6wXocnYmog....&screen=Qd2HRMrs8oJGtA82doE7Jg....&zhuanyeno=537"
            post_data = {
                "__EVENTTARGET": "btnNext",
                "__EVENTARGUMENT": "",
                "__LASTFOCUS": "",
